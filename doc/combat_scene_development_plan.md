...
| 2026-08-18 - 2026-08-31 | M6. 사기, 상태 이상, 부상 | P1 | 부분완료 | 사기 체크, `fleeing`, 전장 이탈, 기절/출혈/그물/방패벽 완료. 부상, 사기 배율 남음 |
...
- 우선순위 5: 남은 P1 확장 후보를 부상, 시야/안개, 엄폐/오발,
  전투 후 XP/전리품 순서로 재정렬.
...
- 상태: 안정화 진행 중.
- 자동 검증 기준: `gdlint` 통과, GUT 150개 통과.
...
13. 남은 P1 확장 후보는 부상, 시야/안개, 엄폐/오발, 전투 후 XP/전리품 순서로
   별도 작업 단위로 분리한다.
