...
- `BrotherData`, 형제단 배경, 전체 적 로스터, 챔피언 변형, 특성/퍽 전체 보정,
  시야/안개, 도망 성공/전장 이탈 처리, 부상 심화, 전투 후 XP/전리품 반영은 아직
  구현되어 있지 않다.
...
| 2026-08-18 - 2026-08-31 | M6. 사기, 상태 이상, 부상 | P1 | 부분완료 | 사기 체크, `fleeing`, 기절/출혈/그물/방패벽 완료. 도망 이탈, 부상, 사기 배율 남음 |
...
- 이번 알파 최소판 완료: `fleeing` 전환, 공격/회복/대기 조작 제한, ZoC 비활성화,
  화면 자동 진행, 가장자리 이동 도망 AI.
- 남은 확장: 도망 성공/전장 이탈 처리, 사기 상태별 능력치 배율, 창벽/반격/불굴,
...
- 우선순위 5: 남은 P1 확장 후보를 도망 이탈 처리, 부상, 시야/안개, 엄폐/오발,
  전투 후 XP/전리품 순서로 재정렬.
...
- 상태: 안정화 진행 중.
- 자동 검증 기준: `gdlint` 통과, GUT 149개 통과.
...
- 완료: `fleeing` 전환, 조작 제한, ZoC 비활성화, 기본 도망 AI.
- 남음: 도망 성공/전장 이탈 처리.
...
13. 남은 P1 확장 후보는 도망 이탈 처리, 부상, 시야/안개, 엄폐/오발,
   전투 후 XP/전리품 순서로 별도 작업 단위로 분리한다.
